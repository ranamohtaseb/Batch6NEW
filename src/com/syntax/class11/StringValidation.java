...
// to compare 2 Strings
		...
		System.out.println("________EqualIsIgnoreCase() Function");
		...
		if (actual.equals(expected)) {
			System.out.println("Test case passs. Titles are matched");
		} else {
			System.out.println("Test case failed. Titles are not matched");

		}
		System.out.println("_________First Trim and then Compare____");
...
}else {System.out.println("Test case fails. Titles are NOT matched");
